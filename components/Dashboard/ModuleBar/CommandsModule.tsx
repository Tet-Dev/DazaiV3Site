...
export const CommandsModule = (props: {
  guildID: string;
  ...
  return (
    <TemplateModule>
      <div className={`flex flex-col justify-between h-full py-1`}>
        <CommandLineIcon className={`w-12 h-12 text-indigo-200`} />
        <span className={`text-xl font-bold font-poppins text-indigo-400`}>
          401
        </span>
        <span className={`text-base text-indigo-100`}>Commands issued this week</span>
      </div>
    </TemplateModule>
  );
};
