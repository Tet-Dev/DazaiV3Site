    ...
    >
      ...
      >
        ...
        <div className={`flex flex-col gap-4 z-10`}>
          <div className={`text-2xl font-bold font-poppins xl:text-xl`}>
            {musicData.track?.title}
          </div>
          <div className={`text-gray-400 font-wsans xl:text-lg`}>
